...
public class App {
	...
	public static void main(String[] args) {
		...
		CropModel beanModel = new CropModel("CRGRO046", new File("sample\\CCLA1302.BNA"), new File("sample\\CCLA1302.BNT"), new File("sample\\CCLA1303_head.BNX"), new File("sample\\CCLA1303_tail.BNX"), new File("sample\\BNGRO046_head.CUL"));
